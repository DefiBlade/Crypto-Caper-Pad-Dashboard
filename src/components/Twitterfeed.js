                ...
                <div className="tweets row px-3">
                    <div className="tweet col-md-4">
                        <blockquote className="twitter-tweet" data-dnt="true" data-theme="dark" data-chrome="noheader nofooter noborders" data-cards="hidden" data-height="800">
                            <a href="https://twitter.com/Casper_Pad/status/1493284695076974597?ref_src=twsrc%5Etfw">February 14, 2022</a>
                        </blockquote>
                    </div>
                    <div className="tweet col-md-4">
                        <blockquote className="twitter-tweet" data-dnt="true" data-theme="dark" data-chrome="noheader nofooter noborders" data-cards="hidden" data-height="800">
                            <a href="https://twitter.com/Casper_Pad/status/1493284692761718784?ref_src=twsrc%5Etfw">February 14, 2022</a>
                        </blockquote>
                    </div>
                    <div className="tweet col-md-4">
                        <blockquote className="twitter-tweet"  data-dnt="true" data-theme="dark" data-chrome="noheader nofooter noborders" data-cards="hidden" data-height="800">
                            <a href="https://twitter.com/Casper_Pad/status/1493284690907783179?ref_src=twsrc%5Etfw">February 14, 2022</a>
                        </blockquote>
                    </div>
                </div>
            </div>
