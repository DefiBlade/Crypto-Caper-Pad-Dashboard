...
import SkyBridgeLogo from '../assets/img/top/SkyBridgerLOGO.png'
                        ...
                        <div className='w-100'>
                            ...
                            <Navbar.Collapse color='white' id="basic-navbar-nav" className='mt-3 align-self-end justify-content-end'>
                                <Nav className="m-nav align-items-center">
                                    ...
                                    <Button className='ms-3 t-btn no-padding' variant="outline" onClick={() => {window.open('https://skybridger.io/', "_blank")}}><img src={SkyBridgeLogo} class="skybridge-btn"></img></Button>
                                </Nav>
                            </Navbar.Collapse>
                        </div>
                    </Navbar>
