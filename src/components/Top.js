...
import  SwapperyIcon  from '../assets/img/icons/swappery.png';
                            ...
                            <div className='row mt-5'>
                                <div className='col-md-9' style={{margin: 'auto'}}>
                                    <div className='justify-content-between buttons'>
                                        <Button className='col-md-8 rbtn' variant="contained" onClick={() => {window.open('https://www.the-swappery.com/swap?inputCurrency=0xef9481115ff33e94d3e28a52d3a8f642bf3521e5', "_blank")}}>Buy on The Swappery <img src={SwapperyIcon} class="swappery-icon"></img></Button>
                                        <Button className='col-md-8 rbtn' variant="contained" endIcon={<RabbitIcon />} onClick={() => {window.open('https://pancakeswap.finance/swap?outputCurrency=0xef9481115ff33e94d3e28a52d3a8f642bf3521e5', "_blank")}}>Buy on PancakeSwap</Button>
                                        <Button className='col-md-4 right-btn' variant="outline" endIcon={<ArrowForward />} onClick={() => {window.open('https://staking.casper-pad.io/', "_blank")}}>Open CasperPad App</Button>
                                        <Button className='col-md-4' variant="outline" endIcon={<ArrowForward />} onClick={() => {window.open('https://sale.casper-pad.io/', "_blank")}}>Open Public Sale App</Button>
                                    </div>
                                </div>
                            </div>
                        </div>
